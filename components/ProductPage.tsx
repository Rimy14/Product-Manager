...
export default function ProductPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg)" }}>
      ...
      >
        <div style={{ width: "100%", paddingLeft: "32px", paddingRight: "32px", height: "60px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
      ...
      <main style={{ width: "100%", paddingLeft: "32px", paddingRight: "32px", paddingTop: "40px", paddingBottom: "64px", boxSizing: "border-box" }}>
